...
\newabbreviation{arch}{ARCH}{auto-regressive conditional \gls{heteroscedasticity}}
\newabbreviation{garch}{GARCH}{general auto-regressive conditional \gls{heteroscedasticity}}
\newabbreviation{var}{VAR}{vector autoregression}
...
\newglossaryentry{heteroscedasticity}
{
    name=heteroscedasticity,
    description={The presence of non‑constant variance in the errors of a regression model, meaning that the spread of residuals changes systematically across levels of the predictor(s)}
}

\newglossaryentry{cointegration}
{
    name=cointegration,
    description={A statistical relationship in which two or more non‑stationary time series move together over time such that a linear combination of them is stationary}
}

\newglossaryentry{cointegrated}
{
    name=cointegrated,
    description={},
    see={cointegration}
