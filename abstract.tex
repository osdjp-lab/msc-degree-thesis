...
The purpose of this master's thesis is to explore the applicability of artificial intelligence algorithms for predicting exchange rates. Forecasting exchange rates is a significant challenge for both financial institutions and individual investors. The thesis focuses on analysing various machine learning algorithms, such as neural networks, support vector machines (SVMs), and random forests, for their effectiveness and accuracy in forecasting currency values.\\
