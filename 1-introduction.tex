...
This research paper is organized as follows. Section one will contain a description of the research problem, the goal of this thesis and an overview of the contents of the paper. Section 2 will be a summary of the theory of time series models, \gls{ai} techniques and \gls{forex} rate forecasting. Section three will cover past research techniques, methodologies and results from relevant articles. Section four will contain a brief overview of used tools. Section five will be a detailed description of data preparation steps carried out before model creation. Section six will cover the methodology of model training and evaluation. Section seven will summarise the conclusions of the research.
