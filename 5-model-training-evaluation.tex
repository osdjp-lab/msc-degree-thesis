...
For the \gls{mlp} the following parameter grid was chosen:
\begin{itemize}
...
For the \gls{rf} the following parameter grid was chosen:
\begin{itemize}
...
For \gls{svr} the following parameter grid was chosen:
\begin{itemize}
