...
\begin{figure}[h!]
    \includegraphics[width=\textwidth]{images/preprocessing/3-optional/log-transform/usd-ff-log.png}
    \centering
    \caption{A graphical comparison of forward filled and log transformed data on the basis of the \gls{usd} spot exchange rate.}
    \label{fig:usd-ff-log}
\end{figure}
...
\begin{figure}[h!]
    ...
    \centering
    \caption{The forward filled differenced \gls{usd} spot exchange rate.}
    \label{fig:usd-diff}
\end{figure}
