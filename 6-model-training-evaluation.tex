...
The parameters being optimized via OptunaSearchCV for each model as well as there selected value distributions are presented in table \ref{tab:mlp-hyperparams} for \gls{mlp}, table \ref{tab:rf-hyperparams} for \gls{rf}, table \ref{tab:svr-hyperparams} for \gls{svr} and table \ref{tab:arima-hyperparams}.
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/metrics-by-dataset/arima_hitrate.png}
    \centering
    \caption{The \gls{ds} for the \gls{arima} model for various preprocessing steps. The sets of processing steps are indicated in shorthand as follows: l - log transformed, d - differenced, n - normalized, s - standardized, r - raw.}
    \label{fig:arima-ds}
\end{figure}
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
        \multirow{2}{*}{\begin{tabular}{@{}c@{}}\gls{arima}\end{tabular}} & \begin{tabular}{@{}c@{}}\gls{mse}\end{tabular} & log-differenced \\
        \cline{2-3}
        \multirow{-1}{*}{} & \begin{tabular}{@{}c@{}}Hitrate\end{tabular} & diff-standardized \\
        \hline
    \end{tabular}
...
\begin{figure}[h]
    ...
    \centering
    \caption{Comparison of the \gls{ds} of the forecasts for the best dataset preprocessing variant for each model for each offset. The sets of processing steps are indicated in shorthand as follows: l - log transformed, d - differenced, n - normalized, s - standardized, r - raw.}
