...
The parameters being optimized via OptunaSearchCV for each model as well as there selected value distributions are presented in table \ref{tab:mlp-hyperparams} for \gls{mlp}, table \ref{tab:rf-hyperparams} for \gls{rf} and table \ref{tab:svr-hyperparams} for \gls{svr}.
...
The forecasts obtained in the previous step were reverse transformed to obtain values in the same range as those of the original \gls{eer}. This was done due to the scale dependant nature of the \gls{mse} metric. Next for each dataset variation the cumulative averages for all offsets of the average \gls{mse} and \gls{ds} for the training and test set forecasts were calculated. As a result multiple rankings were obtained which can be seen in figures \ref{fig:mlp-mse} and \ref{fig:mlp-ds} for \gls{mlp}, figures \ref{fig:rf-mse} and \ref{fig:rf-ds} for \gls{rf} and figures \ref{fig:svr-mse} and \ref{fig:svr-ds} for \gls{svr}.
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/metrics-by-dataset/mlp_hitrate.png}
    \centering
    \caption{The \gls{ds} for the \gls{mlp} model for various preprocessing steps. The sets of processing steps are indicated in shorthand as follows: l - log transformed, d - differenced, n - normalized.}
    \label{fig:mlp-ds}
\end{figure}
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/metrics-by-dataset/rf_hitrate.png}
    \centering
    \caption{The \gls{ds} for the \gls{rf} model for various preprocessing steps. The sets of processing steps are indicated in shorthand as follows: l - log transformed, d - differenced, n - normalized, s - standardized, r - raw.}
    \label{fig:rf-ds}
\end{figure}
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/metrics-by-dataset/svr_hitrate.png}
    \centering
    \caption{The \gls{ds} for the \gls{svr} model for various preprocessing steps. The sets of processing steps are indicated in shorthand as follows: l - log transformed, d - differenced, s - standardized.}
    \label{fig:svr-ds}
\end{figure}
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|}
        \hline
        \textbf{Model} & \textbf{Metric} & \textbf{Preprocessing Steps} \\
        \hline
        \multirow{2}{*}{\begin{tabular}{@{}c@{}}\gls{mlp}\end{tabular}} & \begin{tabular}{@{}c@{}}\gls{mse}\end{tabular} & log-normalized \\
        \cline{2-3}
        \multirow{-1}{*}{} & \begin{tabular}{@{}c@{}}Hitrate\end{tabular} & log-diff-normalized \\
        \hline
        \multirow{2}{*}{\begin{tabular}{@{}c@{}}\gls{rf}\end{tabular}} & \begin{tabular}{@{}c@{}}\gls{mse}\end{tabular} & raw \\
        \cline{2-3}
        \multirow{-1}{*}{} & \begin{tabular}{@{}c@{}}Hitrate\end{tabular} & log-transformed \\
        \hline
        \gls{svr} & \gls{mse}/Hitrate & log-diff-standardized \\
        % \multirow{2}{*}{\begin{tabular}{@{}c@{}}SVR\end{tabular}} & \begin{tabular}{@{}c@{}}MSE\end{tabular} & log-diff-standardized \\
        % \cline{2-3}
        % \multirow{-1}{*}{} & \begin{tabular}{@{}c@{}}Hitrate\end{tabular} & log-diff-standardized \\
        \hline
    \end{tabular}
    \caption{The best dataset preprocessing steps per model per metric.}
    \label{tab:best-datasets}
\end{table}

\newpage

For the purpose of comparing the overall performance of different models the average \gls{mse} and \gls{ds} over both the train and test sets over all offsets was calculated. The results are visible in bar charts in figure \ref{fig:mse-model-cmp} for the \gls{mse} and figure \ref{fig:ds-model-cmp} for the \gls{ds}. On this basis it can be said that for the \gls{mse} the best performing models are the \gls{mlp} followed by the \gls{svr} and the \gls{rf} on the other hand for the \gls{ds} the best performing model is \gls{svr} followed by the \gls{rf} with the worst being the \gls{mlp}.
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/metrics-by-model/hitrate.png}
    \centering
    \caption{Comparison of the highest cumulative average of the average \gls{ds} over train and test sets of all offset forecasts for the best dataset preprocessing variant for each model.}
    \label{fig:ds-model-cmp}
\end{figure}

\subsection{Forecasts}\label{Forecasts}

In the next step cumulative bar charts of the \gls{mse} figure \ref{fig:cumulative-mse} and the \gls{ds} figure \ref{fig:cumulative-ds} of the forecasts were created to illustrate the relative performance of each model on the basis of it's best dataset preprocessing variant for each offset.
...
\begin{figure}[h]
    ...
    \centering
    \caption{Comparison of the \gls{mse} of the forecasts for the best dataset preprocessing variant for each model for each offset.}
    \label{fig:cumulative-mse}
\end{figure}

\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/metrics-by-offset/all-ds.png}
    \centering
    \caption{Comparison of the \gls{ds} of the forecasts for the best dataset preprocessing variant for each model for each offset.}
    \label{fig:cumulative-ds}
\end{figure}
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/forecast-comparison/1.png}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/forecast-comparison/2.png}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/forecast-comparison/3.png}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/forecast-comparison/4.png}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/forecast-comparison/5.png}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/forecast-comparison/6.png}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/forecast-comparison/7.png}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/forecast-comparison/8.png}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/forecast-comparison/9.png}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/forecast-comparison/10.png}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/forecast-comparison/11.png}
    \centering
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{images/forecast-comparison/12.png}
    \centering
