...
The range of values selected for each model was selected through manual experimentation to be broad an provide ample search space for optimization of each model.
